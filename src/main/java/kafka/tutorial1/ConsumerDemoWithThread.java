...
public class ConsumerDemoWithThread {
    ...
    private void run() {
        ...
        logger.info("Creating latch for dealing with multiple threads");
    ...
    public class ConsumerRunnable implements Runnable {
        ...
        public void run() {
            try {
                ...
                consumer.close();
                //tell our main cide that we're done with the consumer
                latch.countDown();
            }
        }

        public void shutdown() {
            //throws wakeupException to interrupt the run method consumer.poll
            consumer.wakeup();
        }
    }
